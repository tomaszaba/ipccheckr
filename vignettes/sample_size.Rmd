---
title: "How to check if IPC Acute Malnutrition minimum sample size requeriments were met"
author: "Tomás Zaba"
date: "`r format(Sys.Date(), '%B %d, %Y')`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to check if IPC Acute Malnutrition minimum sample size requeriments were met}
